...
<body>
  ...
  <div class="form-container">
    <div class="form-box">
      ...
      <form method="post" id="cadastroFuncionarioForm" action="./.././.././../controle/ControleUsuario.php?ACAO=cadastrarfuncionario">
        ...
        <div class="input-container">
          ...
          <input type="number" id="salario" name="salario" placeholder="Digite o salário" required min="0" step="0.1" title="Insira um valor numérico para o salário">
        </div>
        <div class="input-container">
